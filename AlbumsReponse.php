...
<?php   // Connexion odbc
$auteur = $_POST['Auteur'];
echo "<h3 style='text-align: center; color: #e52404;'> Albums pour la lettre ".$auteur."</h3>";
...
$requete = "Select DISTINCT Code_Album , Titre_Album from Album Where Titre_Album Like '".$auteur."%' ";
