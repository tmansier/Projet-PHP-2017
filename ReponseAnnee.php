...
<div id="Result">
    <?php   // Connexion odbc
    $annee = $_POST['Annee'];
    echo "<h3 style='text-align: center; color: #e52404;'> Albums pour l'année".$annee."</h3>";
    ...
    $requete = "Select Album.Code_Album , Album.Titre_Album from Album Where Année_Album ='".$annee."' ";
