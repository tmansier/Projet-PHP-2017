...
<body>
    ...
    <h3 style="text-align:center; color: #e52404;"> A Propos </h3>

    <div class="section no-pad-bot" id="index-banner" style="padding: 5px; border: 10px;">
        <h5 class="center white-text">Projet de Web 2016-2017</h5>
    </div>
    <div class="section">
        <div class="row s12" style="padding-right: 10px">
            <div class="col s6 l6 white z-depth-2">
                <h6 style="color: #23b000;"> Présentation du sujet </h6>
                <p> Ce projet est réalisé au cours du module de Programmation Web. </p>
                <p> Le but est de réaliser un site de e-commerce permettant de lier la base de données <i>Classique_Web</i> mise à disposition par l'IUT. </p>
                <p> Ce projet a été développé par <b>Meriem AKKOUCHE</b> et <b>Thibault MANSIER</b>. </p>
                <br><br>
            </div>
            <div class="col s6 l6 white z-depth-2">
                <h6 style="color: #23b000;"> Nos choix techniques</h6>
                <p> Ce site a été réalisé en combinant les langages <i>PHP</i>, <i>HTML</i>, <i>JavaScript</i>. De plus, nous avons utilisé un framework CSS <i>MaterializeCss</i>.</p>
            </div>
        </div>
    </div>
