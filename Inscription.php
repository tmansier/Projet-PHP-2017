...
<?php
    ...
    echo "<h3 style='text-align:center; color: #e52404;'> Récapitulatif d'Inscription </h3>";
    echo"<div class='section'>";
    echo"<div class='row s12' style='padding-right: 10px'>";
    echo"<div class='col s3'></div>";
    echo" <div class='col s6'>";

    echo 'Bonjour, ' . 'votre inscription a bien été prise en compte' . '<br>';
    echo 'Vous êtes ' . $_POST['nom'] . " ". $_POST['prenom'] . '.' . '<br>';
    echo '<br>';
    echo 'Votre login est ' . $_POST['login'] . " et votre mot de passe est " . $_POST['pass'] . "." . '<br>';
    echo '<br>';
